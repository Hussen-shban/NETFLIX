...
const SmNav = ({ hidden }) => {
    ...
    useEffect(() => {
        ...
        recognition.onresult = (event) => {
            ...
            // handleSearch(); // ← فعّل إذا أردت تشغيل البحث تلقائيًا بعد التسجيل
        };
        ...
        <div className='md:hidden flex items-center justify-between w-full'>
            ...
            {!hidden && (
                <div onClick={handleopenlist} className={`${open && "hidden"}`}>
                    <img src="/images/menu.png" className='w-5 cursor-pointer' alt="menu" />
                </div>
            )}
            ...
            `}>
                <div className='w-full flex justify-end px-2 pt-3'>
                    <img onClick={handleopenlist} className='w-10 cursor-pointer' src="svgs/xmark.svg" alt="close" />
                </div>
                ...
                <div className='flexcenter relative mt-5 gap-3 px-3'>
                    <div className="search-container w-full">
                        <div className="search-bar">
                            ...
                            <button type="button" onClick={startListening} className="search-icon">
                                {!listening ? (
                                ...
                                {!loading ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                                        ...
                                        <path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5
                                                ...
                                                4.99L20.49 19l-4.99-5zM9.5 14C7.01 14 5
                                                11.99 5 9.5S7.01 5 9.5 5 14 7.01 14
                                                9.5 11.99 14 9.5 14z"></path>
                                    </svg>
                                ) : (
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <path fill="none" stroke="#fff" strokeDasharray="16" strokeDashoffset="16" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                    ...
                    {suggestions.length > 0 && (
                        <ul className="absolute top-[110%] left-1/2 -translate-x-1/2 w-[93%] bg-white text-black rounded shadow-md z-10 max-h-60 overflow-auto">
